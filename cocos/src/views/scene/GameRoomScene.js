        ...
        if(h1global.entityManager.player().curGameRoom.isPlayingGame){
            ...
            if (h1global.entityManager.player().isPlayingStartAnimation) {
                ...
                curUIManager.gameroom_ui.show(function(){
                    ...
                    // var deskPokerList = h1global.entityManager().player.curGameRoom.deskPokerList
                    // for (var i = 0; i < deskPokerList.length; i++) {
                    //     h1global.curUIMgr.gameroom_ui.update_discard_card_panel(i, deskPokerList[i])
                    // }
